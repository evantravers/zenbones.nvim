...
local function build_helix_theme(colorscheme)
	local s, palette = unpack(colorscheme)
	local lines = {}
	...
	add("ui.text.info", fg_style(s.DiagnosticInfo.fg, {}))
	...
	add("ui.virtual.whitespace", fg_style(s.NonText.fg, {}))
	add("ui.virtual.indent-guide", fg_style(s.NonText.fg, {}))
	add("ui.virtual.inlay-hint", fg_bg_style(s.LspInlayHint.fg, s.LspInlayHint.bg, {}))
	add("ui.virtual.wrap", fg_style(s.NonText.fg, {}))
